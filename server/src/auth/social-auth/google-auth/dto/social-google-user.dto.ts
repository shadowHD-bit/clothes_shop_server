...
export class SocialGoogleAuthUserDto {
  ...
  @ApiProperty({example: "default_avatar.png", description: 'Аватар пользователя'})
  readonly avatar: string;

  @ApiProperty({example: true, description: 'Флаг разрешения на рассылку'})
  readonly allowMailling: boolean;

  @ApiProperty({example: "78928182828", description: 'Идентификатор сервиса Google пользователя'})
